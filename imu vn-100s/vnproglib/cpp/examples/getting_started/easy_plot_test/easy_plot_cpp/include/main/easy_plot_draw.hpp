...
namespace easy_plot {
    namespace tools {
        ...
        private:
            ...
            EasyWindowSpec window_style;                        /**< Стиль окна */
            ...
            void init(const std::string &name, const EasyWindowSpec &wstyle, const std::vector<std::vector<T1>> &x, const std::vector<std::vector<T2>> &y, const std::vector<LineSpec> &styles) {
                is_raw_data = false;
                image_type = CURVE;
             ...
             */
            template <typename T1>
            void init(const std::string &name, const EasyWindowSpec &wstyle, const std::vector<T1> &y, const LineSpec &style) {
            ...
            template <typename T1>
            Drawing(const std::string &name, const EasyWindowSpec &wstyle, const std::vector<T1> &y, const LineSpec &style) {
             ...
             */
            template <typename T1, typename T2>
            void init(const std::string &name, const EasyWindowSpec &wstyle, const std::vector<T1> &x, const std::vector<T2> &y, const LineSpec &style) {
                std::vector<LineSpec> vstyle = get_style_values(style);
            ...
            template <typename T1, typename T2>
            Drawing(const std::string &name, const EasyWindowSpec &wstyle, const std::vector<T1> &x, const std::vector<T2> &y, const LineSpec &style) {
             ...
             */
            template <typename T1>
            void init(const std::string &name, const EasyWindowSpec &wstyle, const std::vector<std::vector<T1>> &vec, const std::vector<LineSpec> &styles) {
                std::vector<std::vector<int>> vx = get_x_axis_values(vec);
                init(name, wstyle, vx, vec, styles);
            }

            template <typename T1>
            Drawing(const std::string &name, const EasyWindowSpec &wstyle, const std::vector<std::vector<T1>> &vec, const std::vector<LineSpec> &styles) {
             ...
             */
            void init(const std::string &name, const EasyWindowSpec &wstyle, const float *image_data, const size_t width, const size_t height) {
                is_raw_data = false;
                //image_type = CURVE;
             ...
             * \param height высота изображения
             */
            Drawing(const std::string &name, const EasyWindowSpec &wstyle, const float *image_data, const size_t width, const size_t height) {
