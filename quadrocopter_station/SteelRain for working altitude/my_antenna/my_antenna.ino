...
void gps_setup(){
  while (!station_latitude || !station_longitude || !station_altitude){
#if MODE == DEBUG_ON
...
void get_station_location()
{
  if (gps.location.isValid())
  {
    ...
    //station_altitude  = gps.altitude.meters();
#if MODE == DEBUG_ON
...
void writeServos(int vert, int hor){
  if (stateHor){
