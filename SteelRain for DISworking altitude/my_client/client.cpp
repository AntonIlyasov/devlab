...
#define ZAPRAVKA        " 60.02905 30.259607 200"
...
#define RIGHT_45_DEG    " 60.028726 30.262057 300"
#define LEFT_45_DEG     " 60.028794 30.250932 500"
...
int main()
{
    ...
    while(send_count > 0){
        ...
        std::string message = LEFT_45_DEG;
        // std::string message = "";
